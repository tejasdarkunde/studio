  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.role === 'trainer' || result.role === 'superadmin') {
            ...
            router.push(`/organization/${result.organizationName}`);
             ...
             // If role is not admin/trainer, it's an invalid login for this page.
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>Enter your credentials to access the administrative portal.</CardDescription>
            </CardHeader>
            <CardContent>
                <Form {...form}>
